(function (global, factory) {
  ...
  function transform(node) {
    return node && node.__zoom || identity$6;
  }
  ...
  function zoom(started) {
    ...
    function wheeled() {
      ...
      var g = gesture(this, arguments),
          p0,
          p1,
          y = -exports.event.deltaY * (exports.event.deltaMode ? 120 : 1) / 500,
          t = this.__zoom,
          k = t.k;
    ...
    zoom.size = function(_) {
      return arguments.length ? (size = typeof _ === "function" ? _ : constant$9([+_[0], +_[1]]), zoom) : size;
    };
